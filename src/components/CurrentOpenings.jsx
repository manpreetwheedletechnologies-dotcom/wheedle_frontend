...
const CurrentOpenings = ({ onStartNowClick }) => {
  ...
  return (
    <>
      <section
        className="w-full px-6 sm:px-10 lg:px-[100px] py-20  relative overflow-hidden"
      >
        ...
        <div className="max-w-[1440px] mx-auto">
          {/* Heading */}
          <h2
            className="font-gotham font-normal  text-white  text-[36px] sm:text-[44px] lg:text-[53px]  leading-[48px] lg:leading-[63px] animate-bounce"
          >
            Current Openings
          </h2>
          ...
          {/* Sub text */}
          <p
            className="font-inter font-medium text-white text-[16px] leading-[26px] mt-3"
          >
            ...
            {jobs.map((job, index) => (
              ...
              >
                ...
                <div className="flex flex-col flex-1 p-6 gap-3 bg-[#0B0F1A]">
                  {/* Location */}
                  <span
                    className="font-inter font-normal text-[12px] leading-[22px] text-[#2934E4]"
                  >
                    {job.location}
                  </span>
                  ...
                  {/* Description */}
                  <p
                    className="font-inter font-normal text-[14px] leading-[24px] text-white"
                  >
                    {job.desc}
                  </p>
      ...
      <section
        className="w-full px-6 sm:px-10 lg:px-[100px] py-24 relative overflow-hidden"
      >
        {/* Background glow */}
        ...
        <div className="relative max-w-[1440px] mx-auto">
          <div className="flex flex-col lg:flex-row items-center lg:items-start gap-14">
            ...
            <div className="relative w-full lg:w-[545px] group">
              <div className="absolute inset-0 rounded-[30px] bg-gradient-to-r from-[#0B2CC3] via-[#4F6BFF] to-[#0B2CC3] blur-[14px] opacity-60 
               transition-all duration-500 ease-out group-hover:opacity-90 group-hover:scale-105" />

              <div className="relative w-full aspect-[545/403]">
                <img
                  src="image.png"
                  alt="Team"
                  className="w-full h-full object-cover rounded-[30px] border border-[#0B2CC3] shadow-[0_0_40px_rgba(11,44,195,0.45)] transition-all duration-500 ease-out group-hover:scale-105"
                />
              </div>
            </div>
            ...
            <div className="w-full lg:w-[645px] flex flex-col gap-[32px]">
              ...
              <div>
                ...
                <p className="font-inter font-normal text-white text-[16px] leading-[26px] mt-1">
                  We believe in the character of our team members and hence value:
                </p>
              </div>
              ...
              <ul className="space-y-1.5">
                {[
                  ...
                  <li key={index} className="flex items-start gap-2 transition-transform
